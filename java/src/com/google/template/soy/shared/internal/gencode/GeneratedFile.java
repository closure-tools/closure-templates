...
public abstract class GeneratedFile {
  public static GeneratedFile create(SoyFileNode source, String fileName, String contents) {
    return new AutoValue_GeneratedFile(source, fileName, contents);
  }

  public static GeneratedFile create(String fileName, String contents) {
    return create(null, fileName, contents);
  }

  public abstract SoyFileNode source(); // Soy source this file is generated from.
